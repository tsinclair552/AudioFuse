# AudioFuse - Desktop application that takes two audio clips as input and combines them into a single output clip, with an optional silent gap between them.
